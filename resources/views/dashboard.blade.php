...
<body class="bg-white">
    <div class="flex-center position-ref full-height">
        ...
        <div class="content">
            <div class="text-[20px]">Welcome to </div>
            <div class="text-[80px]">
                Stonks Pizza
            </div>
            <div>
                ...
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55.821 55.821"
                    style="enable-background:new 0 0 55.821 55.821;" xml:space="preserve">
                    <g>
        ...
        c1.101-0.458,1.932-1.303,2.414-2.32C55.45,22.986,55.251,24.222,54.734,25.294z" />
                        <g>
                            <path style="fill:#F4C44E;"
                                d="M55.729,18.703C51.876-0.572,22.861,1.707,9.95,3.738C7.846,4.069,6.254,5.783,6.043,7.892
        ...
        l1.082-3.103c0.044-0.127,0.059-0.257,0.052-0.383C36.484,3.278,35.847,3.17,35.204,3.075z" />
                        <path style="fill:#E0AB36;"
                            d="M42.363,4.764c-0.039,0.061-0.087,0.114-0.113,0.185l-1.207,3.33
        ...
        C25.015,30.284,25.008,30.284,25,30.284z" />
                        <path style="fill:#659C35;"
                            d="M11.443,25.426c-0.134,0-0.271-0.027-0.402-0.085c-0.506-0.222-0.735-0.813-0.513-1.317
        ...
        s7.194-4.814,8.667-4.814S44.333,15.456,44.333,18.275z" />
            ...
            <div>
                <a type="button"  class="focus:outline-none text-white bg-green-700 w-36
                hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-bold rounded-lg
                px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href="{{ route('products.list') }}">Menu</a>
            </div>
